...
public class Dictionary {
    ...
    public void sort() {
        for (List<String> firstLetterDict: dictionary
             ) {
            firstLetterDict.sort(String::compareTo);
        }
    }

    public void add(String word) {
        dictionary[word.toLowerCase().charAt(0) - 97].add(word);
    }
